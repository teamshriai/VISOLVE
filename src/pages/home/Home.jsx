      ...
      <section className="relative w-full bg-white py-4 sm:py-6 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-center">
            ...
            {/* LEFT: Hero Carousel (70-75% width on desktop) */}
            <div className="lg:col-span-8 xl:col-span-9 relative w-full aspect-[964/400] max-h-[480px] rounded-xl sm:rounded-2xl overflow-hidden shadow-sm border border-gray-100 bg-white">
            ...
            {/* RIGHT: Portfolio CTA Area (25-30% width on desktop) */}
