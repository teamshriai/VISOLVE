      ...
      <div className="max-w-7xl mx-auto flex items-center justify-center">
        ...
        >
          {/* Small Icon in Circular Background — top-aligned on narrow screens where
              the copy wraps to several lines, so it stays anchored to "Proud to
              support" instead of drifting to the vertical middle of the block */}
          ...
          <span className="inline-flex flex-wrap items-center gap-2">
            <strong className="font-bold text-white">Proud to support Shri-AI.org</strong>
            <span className="text-white/90 font-medium">in redefining Healthcare with AI —</span>
